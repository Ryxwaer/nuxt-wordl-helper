<template>
  <Transition name="fade-scale">
    <div v-if="isVisible" class="fixed bottom-8 right-8 z-50">
      <div class="relative motion-translate-y-in-100 motion-duration-[2s] motion-ease-spring-smooth">
        ...
        >
          ...
          <button
            ...
            class="absolute -top-3 -right-2 md:-top-4 md:-right-3 bg-gray-100 dark:bg-gray-800 h-8 w-8 md:h-12 md:w-12 rounded-full flex items-center justify-center cursor-pointer text-lg md:text-2xl font-bold text-white border border-white dark:border-black shadow hover:bg-gray-600 hover:text-white"
            aria-label="Close"
          >
            ×
          </button>
